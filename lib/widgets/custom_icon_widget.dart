...
class CustomIconWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Icon builtIcon = Icon(
      iconMap.containsKey(iconName) ? iconMap[iconName] : Icons.help_outline,
      size: size,
      color: iconMap.containsKey(iconName) ? color : Colors.grey,
      semanticLabel: iconMap.containsKey(iconName) ? iconName : '$iconName',
    );

    // Wrap the icon in a SizedBox and FittedBox so it never overflows
    // when placed into tight or constrained layouts (prevents "overflowed by X pixels").
    return FittedBox(
